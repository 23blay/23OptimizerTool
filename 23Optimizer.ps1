...
function Write-Log {
    ...
    $colors = @{
        ...
        "Error"   = @{ Color = [System.Drawing.Color]::FromArgb(220,20,60); Prefix = "x" }
...
function Invoke-FullOptimization {
    ...
    [System.Windows.Forms.MessageBox]::Show(
        "System optimization completed successfully!`n`nSpace Freed: $([Math]::Round($script:Stats.SpaceFreed, 2)) MB",
...
function Show-SystemInfo {
    ...
    try {
        ...
        Write-Log "RAM: $freeRamGB GB free of $ramGB GB total" Info
...
$richTextBox.Location = New-Object System.Drawing.Point(20, 100)
$richTextBox.Size = New-Object System.Drawing.Size(860, 450)
...
$fullBtn.Size = New-Object System.Drawing.Size(200,40)
...
$infoBtn.Size = New-Object System.Drawing.Size(200,40)
