...
class OptimizerUI(GalaxyBackground):
    def __init__(self):
        ...
        self.settings_panel.setFixedWidth(640)
        self.settings_panel.setMinimumHeight(240)
        ...
        self.settings_subtitle = QLabel("Control visuals, completion dialog, and appearance")
